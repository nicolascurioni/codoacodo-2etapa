...
def agregar_usuario():
    try:
        ...
        # Si el usuario no existe, agregarlo
        if gestor_usuarios.agregar_usuario(usuario, contrasena, nombre, apellido, direccion, ciudad, provincia, telefono):
            return jsonify(message="Usuario agregado correctamente"), 200
        else:
            return jsonify(error_message="Error al agregar el usuario"), 500
